...
public class Vocabulary3 {
    ...
    @FXML
    void initialize() {
        Image o = new Image("C:\\Users\\Admin\\IdeaProjects\\inf\\src\\main\\resources\\com\\example\\inf\\Снимок экрана 2023-12-19 145319.jpg");
        i.setImage(o);
        ...
        image2.setOnMouseClicked(event -> {
            ...
            try {
                ...
                Stage currentStage = (Stage) image2.getScene().getWindow();
                currentStage.close();
